  ...
  <footer class="footer">
    ...
    <div class="container-xxl">
      ...
      <div class="footer-grid">
        ...
        <div class="footer-col footer-col-main">
          <div class="footer-brand">
            ...
            <span class="brand-name">{{ footerContent.companyName }}</span>
          </div>
          <p class="footer-desc">{{ footerContent.description }}</p>

          <!-- Contact -->
          <div class="footer-contacts">
            <div v-if="footerContent.address" class="contact-item">
            ...
            <div v-if="footerContent.email" class="contact-item">
              <div class="contact-icon">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
            ...
            <div v-if="footerContent.phone" class="contact-item">
              <div class="contact-icon">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
        ...
        <!-- Col 2: Social -->
        <div class="footer-col" v-if="socialLinks.length">
      ...
      <div class="footer-bottom">
        <span class="footer-copy">{{ footerContent.copyright }}</span>
...
const footerContent = {
  companyName: 'Mcflyon Teknologi Indonesia',
  ...
  phone: '0897-7266-144',
  copyright: `© ${currentYear} Mcflyon Teknologi Indonesia. All rights reserved.`,
};

const socialLinks = [
  { label: 'Instagram', href: 'https://www.instagram.com/mcflyon.id/' },
];
